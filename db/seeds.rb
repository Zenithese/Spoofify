...
p4 = Playlist.create!(title: "mint Acoustic", user_id: 1)
    p4.photo.attach(io: mintAcoustic, filename: "mintAcoustic.jpg")
p5 = Playlist.create!(title: "POLLEN", user_id: 1)
    p5.photo.attach(io: POLLEN, filename: "POLLEN.jpg")

s1 = Song.create!(title: "Around the World (La La La La La) (Radio Version)", artist_name: "ATC", kind: "Legit", track_url: "https://seedie.s3.amazonaws.com/ATC.mp3", image_url: "https://seedie.s3.amazonaws.com/ATC.jpg")
s2 = Song.create!(title: "Better Off Alone", artist_name: "Alice DJ", kind: "Classic", track_url: "https://seedie.s3.amazonaws.com/BetterOffAlone.mp3", image_url: "https://seedie.s3.amazonaws.com/dj.jpg")
s3 = Song.create!(title: "Show Me Love", artist_name: "Robin S", kind: "Classic", track_url: "https://seedie.s3.amazonaws.com/ShowMeLove.mp3", image_url: "https://seedie.s3.amazonaws.com/robinS.jpg")
s4 = Song.create!(title: "Scatman (Ski Ba Bop Ba Dop Bop)", artist_name: "Scatman", kind: "Scat", track_url: "https://seedie.s3.amazonaws.com/Scatman.mp3", image_url: "https://seedie.s3.amazonaws.com/scatman.jpg")
s5 = Song.create!(title: "Aaron Carter - That's How I Beat Shaq", artist_name: "Aaron Carter", kind: "Beats", track_url: "https://seedie.s3.amazonaws.com/AaronCarter.mp3", image_url: "https://seedie.s3.amazonaws.com/arron.jpg")
s6 = Song.create!(title: "Crosstwon Traffic", artist_name: "Jimi Hendrix", kind: "Legit", track_url: "https://seedie.s3.amazonaws.com/CrosstownTraffic.mp3", image_url: "https://seedie.s3.amazonaws.com/jimi-hendrix.jpg")
s7 = Song.create!(title: "Born To Be Wild", artist_name: "Steppenwolf", kind: "Classic Rock", track_url: "https://seedie.s3.amazonaws.com/BornToBeWild.mp3", image_url: "https://seedie.s3.amazonaws.com/born2beWild.jpg")
s8 = Song.create!(title: "Further On Up The Road", artist_name: "Johnny Cash", kind: "Classic Rock", track_url: "https://seedie.s3.amazonaws.com/FurtherOnUpTheRoad.mp", image_url: "https://seedie.s3.amazonaws.com/JohnnyCash.jpg")
s9 = Song.create!(title: "Highway Star", artist_name: "Deep Purple", kind: "Classic Rock", track_url: "https://seedie.s3.amazonaws.com/HighwayStar.mp3", image_url: "https://seedie.s3.amazonaws.com/DeepPurple.jpg")
s10 = Song.create!(title: "Life in the Fast Lane", artist_name: "Eagles", kind: "Classic Rock", track_url: "https://seedie.s3.amazonaws.com/LifeintheFastLane.mp3", image_url: "https://seedie.s3.amazonaws.com/EagleImage.jpg")
